...
use them. However, travelMode and timeOfDay will be ignored because they are
specified in the tool dialog.  Specifying a value for defaultImpedanceCutoff
and defaultDestinationCount may yield incorrect statistics results.
...
OD_PROPS_SET_BY_TOOL = ["travelMode",  "timeOfDay"]
...
OD_PROPS = {
    ...
    "defaultImpedanceCutoff": None,  # None means no impedance cutoff.
