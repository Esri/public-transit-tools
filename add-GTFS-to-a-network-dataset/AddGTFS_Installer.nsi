...
File "images\Screenshot_CalculateAccessibilityMatrix_Dialog.png"
File "images\Screenshot_CalculateTravelTimeStatistics_Dialog.png"
File "images\Screenshot_CopyTraversedSourceFeaturesWithTransit_Dialog.png"
File "images\Screenshot_CreatePercentAccessPolygons_Dialog.png"
...
File "images\Screenshot_LayerEnableTime_10x.png"
...
File "images\Screenshot_PrepareTimeLapsePolygons_Dialog.png"
...
createShortCut "$SMPROGRAMS\ArcGIS\TransitTools\Public Transit Tools - Users Guide.lnk" "$INSTDIR\TransitAnalysisTools_UsersGuide.html" "User Guide"
...
File "Transit Analysis Tools.tbx"
# Scripts
SetOutpath "$ToolboxesDir\scripts"
File "scripts\AnalysisHelpers.py"
File "scripts\CalculateAccessibility.py"
File "scripts\CalculateTravelTimeStats.py"
File "scripts\CopyTraversedSourceFeatures_wTransit.py"
File "scripts\CreatePercentAccessPolygon.py"
File "scripts\CreateTimeLapsePolygons.py"
...
File "scripts\Symbology_Cells.lyr"
...
Delete "$INSTDIR\images\Screenshot_CalculateAccessibilityMatrix_Dialog.png"
Delete "$INSTDIR\images\Screenshot_CalculateTravelTimeStatistics_Dialog.png"
Delete "$INSTDIR\images\Screenshot_CopyTraversedSourceFeaturesWithTransit_Dialog.png"
Delete "$INSTDIR\images\Screenshot_CreatePercentAccessPolygons_Dialog.png"
...
Delete "$INSTDIR\images\Screenshot_LayerEnableTime_10x.png"
...
Delete "$INSTDIR\images\Screenshot_PrepareTimeLapsePolygons_Dialog.png"
...
Delete "$ToolboxesDir\Transit Analysis Tools.tbx"
...
Delete "$ToolboxesDir\scripts\AnalysisHelpers.py"
Delete "$ToolboxesDir\scripts\CalculateAccessibility.py"
Delete "$ToolboxesDir\scripts\CalculateTravelTimeStats.py"
Delete "$ToolboxesDir\scripts\CopyTraversedSourceFeatures_wTransit.py"
Delete "$ToolboxesDir\scripts\CreatePercentAccessPolygon.py"
Delete "$ToolboxesDir\scripts\CreateTimeLapsePolygons.py"
...
Delete "$ToolboxesDir\scripts\Symbology_Cells.lyr"
...
DetailPrint " - Public Transit Tools - Users Guide.lnk"
